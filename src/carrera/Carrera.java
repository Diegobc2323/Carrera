		...
		do {
			...
			case 2:
				...
				if (empezar) {
					...
					System.out.println("necesitas añadir coches antes de empezar la carrera");
					opc=3;
				}
			...
			for (int i = 0; i < vCoches.length; i++) {
				if (vCoches[i]==null) {
					...
					if (respuesta.equalsIgnoreCase("si")) {
						...
						System.out.println("el piloto "+nombrePiloto+" ha sido a�adido\n");
						break;
					//	menuCarrera();
					}else {
						vCoches[i]= new Coche("piloto_"+(i+99), (i+99), false, this.distCarrera);
						System.out.println("el piloto "+vCoches[i].getNombrePiloto()+" ha sido a�adido\n");
						break;
					//	menuCarrera();
					}
				}
